-- =====================================================================
-- Migration: duplicate_order_item_v2 — adds idempotency-key support
-- =====================================================================
-- Forks from baseline_duplicate_order_item.sql.
-- Rollback: duplicate_order_item_v2_rollback.sql
-- =====================================================================
...
COMMENT ON FUNCTION public.duplicate_order_item_v2 IS
  'Duplicates an order item. v2 adds optional p_idempotency_key for at-most-once execution.';
