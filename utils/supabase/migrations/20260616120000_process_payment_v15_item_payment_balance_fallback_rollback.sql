-- =====================================================================
-- ROLLBACK for 20260616120000_process_payment_v15_item_payment_balance_fallback
-- =====================================================================
-- Restores process_payment_v15 to its 2026-06-03 body (in-place CREATE OR
-- REPLACE, same name + 14-arg signature, idempotency op 'process_payment_v15').
-- This reverts ONLY the ORD-S2-0001 item-payment fully-paid fallback edit; the
-- v_is_item_payment branch returns to deciding fully-paid solely on
-- v_unpaid_items_count. Body below is verbatim the pre-fix migration.
-- =====================================================================
-- Migration: process_payment_v15 — closing item payment balance snap
-- =====================================================================
...
--
-- Rollback: process_payment_v15_closing_item_balance_rollback.sql (drops
-- v15; client wrappers point back at v14).
-- =====================================================================
