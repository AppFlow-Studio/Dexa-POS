-- =====================================================================
-- Migration: add_order_item_modifier_v2 — adds idempotency-key support
-- =====================================================================
-- Forks from baseline_add_order_item_modifier.sql (the v1/baseline).
-- v1 is NOT modified. Rollback = DROP v2.
--
-- Body between BEGIN_VERBATIM/END_VERBATIM markers is copy-pasted from v1.
-- Assigns to v_result so claim/complete wrappers can cache it.
--
-- Rollback: add_order_item_modifier_v2_rollback.sql
-- =====================================================================
...
GRANT EXECUTE ON FUNCTION public.add_order_item_modifier_v2(uuid, uuid, uuid, text, text, numeric, integer, uuid) TO authenticated;

COMMENT ON FUNCTION public.add_order_item_modifier_v2 IS
  'Adds a modifier to an order item. v2 adds optional p_idempotency_key for at-most-once execution.';
