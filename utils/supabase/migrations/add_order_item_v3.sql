-- =====================================================================
-- Migration: add_order_item_v3 — adds idempotency-key support
-- =====================================================================
-- Forks from add_order_item_v2 in add_order_item_v2.sql.
-- Hot-path RPC — included as Wave 2 slot #2 (canary slot) so the
-- idempotency_keys table sees real volume early in the rollout.
-- Rollback: add_order_item_v3_rollback.sql
-- =====================================================================
