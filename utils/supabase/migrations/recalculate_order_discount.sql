-- ============================================
-- recalculate_order_discount: Recalculates the order discount if it exists else recalculates the order totals using calculate_order_totals_fast
-- Called after ANY item changes
-- ============================================
CREATE OR REPLACE FUNCTION recalculate_order_discount(
DECLARE
    p_order_id uuid,
)
RETURNS jsonb
