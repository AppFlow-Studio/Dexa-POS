-- =====================================================================
-- Migration: create_reversal_v2 — adds idempotency-key support
-- =====================================================================
-- Forks from create_reversal in refund_system_v1.sql.
-- v1 returns the `reversals` table type. v2 caches the row as jsonb and
-- reconstructs via jsonb_populate_record on cache hit.
-- Rollback: create_reversal_v2_rollback.sql
-- =====================================================================
...
BEGIN
  IF p_idempotency_key IS NOT NULL THEN
    ...
    IF v_cached IS NOT NULL THEN
      -- Reconstruct the reversals row from cached jsonb
...
COMMENT ON FUNCTION public.create_reversal_v2 IS
  'Creates a reversal row for refunds/voids. v2 adds optional p_idempotency_key. Cached row reconstructed via jsonb_populate_record on replay.';
