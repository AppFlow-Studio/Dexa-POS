-- =====================================================================
-- Migration: apply_refund_to_payment_v2 — adds idempotency-key support
-- =====================================================================
-- Forks the 10-arg overload of apply_refund_to_payment. The 9-arg overload
-- remains untouched (legacy, unused by current client).
-- v1 returns void; v2 caches '{}'::jsonb on completion.
-- Rollback: apply_refund_to_payment_v2_rollback.sql
-- =====================================================================
...
BEGIN
  IF p_idempotency_key IS NOT NULL THEN
    v_cached := public._idempotency_claim(p_idempotency_key, 'apply_refund_to_payment_v2');
