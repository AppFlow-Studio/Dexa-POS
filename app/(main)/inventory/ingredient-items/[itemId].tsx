...
const transactionMeta = (
  ...
  switch (type) {
    ...
    case "NOTE":
      return { label: "Note", bg: colors.teal + "15", text: colors.teal };
    default:
...
const IngredientItemScreen = () => {
  ...
  const selectedLocationId = useStoreSettingsStore(
  ...
  const handleSave = () => {
    ...
    void updateInventoryItem(item.id, updatedItem, selectedLocationId);
    setItem(updatedItem);
    setIsEditing(false);
  };
  ...
  return (
    ...
    >
      <KeyboardAvoidingView
        ...
        style={{ flex: 1, width: "100%", maxWidth: 420 }}
      >
        {/* Header */}
        <View
          style={{
              ...
              <View style={{ marginBottom: s(10) }}>
                ...
                {logUsageForm.reason === "CUSTOM" && (
                  <TextInput
                    ...
                    onChangeText={(t) =>
                      setLogUsageForm((p) => ({ ...p, customReason: t }))
                    }
                    ...
                    return (
                      ...
                      >
                        <Text
                          style={{
                            fontSize: 13,
                            color: isActive ? colors.success : colors.label,
                            fontWeight: isActive ? "600" : "400",
                          }}
                        >
                          {opt.label}
          ...
          <View style={{ flex: 1 }}>
            ...
            >
              ...
              <TextInput
                ...
                placeholder="Type a note about this item..."
                placeholderTextColor={colors.muted}
                multiline
                numberOfLines={2}
                style={{
