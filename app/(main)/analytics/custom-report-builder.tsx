...
const availableMetrics: MetricOption[] = [
    { id: 'gross_sales', label: 'Gross Sales', description: 'Total sales before discounts' },
    { id: 'net_sales', label: 'Net Sales', description: 'Sales after discounts' },
    { id: 'discount_amount', label: 'Discount Amount', description: 'Total discount value' },
    ...
    { id: 'item_quantity', label: 'Item Quantity', description: 'Total items sold' },
    { id: 'average_order_value', label: 'Average Order Value', description: 'Average value per order' },
];

const availableDimensions: DimensionOption[] = [
    { id: 'item', label: 'Item', description: 'Break down by menu items' },
    { id: 'category', label: 'Category', description: 'Break down by item categories' },
    { id: 'employee', label: 'Employee', description: 'Break down by staff members' },
    { id: 'hour', label: 'Hour', description: 'Break down by hour of day' },
    { id: 'day', label: 'Day', description: 'Break down by day of week' },
    { id: 'payment_method', label: 'Payment Method', description: 'Break down by payment type' },
];
        ...
        <View className="flex-1 bg-[#212121]">
            ...
            <View className="flex-row items-center justify-between p-6 border-b border-gray-700">
                <View className="flex-row items-center">
                    ...
                    <Text className="text-2xl font-bold text-white">Custom Report Builder</Text>
                </View>
            </View>
            ...
            <ScrollView contentContainerClassName="p-6">
                            ...
                            >
                                <View className="flex-row items-center justify-between">
                                    <View className="flex-1">
                                        <Text className={`text-lg font-semibold ${selectedMetrics.includes(metric.id) ? 'text-blue-400' : 'text-white'
                                            }`}>
                                            {metric.label}
                                        </Text>
                                    ...
                                    <View className={`w-6 h-6 rounded-full border-2 ${selectedMetrics.includes(metric.id)
                ...
                {/* Breakdown Selection */}
                <View className="mb-8">
                    <Text className="text-xl font-bold text-white mb-4">Breakdown Dimension</Text>
                    <Text className="text-gray-400 mb-4">
                    ...
                    <View className="space-y-3">
                        {availableDimensions.map((dimension) => (
                            ...
                            >
                                <View className="flex-row items-center justify-between">
                                    <View className="flex-1">
                                        <Text className={`text-lg font-semibold ${selectedBreakdown === dimension.id ? 'text-blue-400' : 'text-white'
                                            }`}>
                                            {dimension.label}
                                        </Text>
                                        <Text className="text-sm text-gray-400 mt-1">
                                    ...
                                    <View className={`w-6 h-6 rounded-full border-2 ${selectedBreakdown === dimension.id
                                        ? 'bg-blue-500 border-blue-500'
                                        : 'border-gray-400'
                                        }`}>
                    ...
                    <View className="flex-row gap-4">
                        ...
                        >
                            <View className="items-center">
                                <BarChart3 color={chartType === 'bar' ? '#60A5FA' : '#9CA3AF'} size={32} />
                                <Text className={`text-lg font-semibold mt-2 ${chartType === 'bar' ? 'text-blue-400' : 'text-white'
                                    }`}>
                                    Bar Chart
                                </Text>
                            </View>
                        ...
                        >
                            <View className="items-center">
                                <TrendingUp color={chartType === 'line' ? '#60A5FA' : '#9CA3AF'} size={32} />
                                <Text className={`text-lg font-semibold mt-2 ${chartType === 'line' ? 'text-blue-400' : 'text-white'
                                    }`}>
                                    Line Chart
                                </Text>
                            </View>
                ...
                <View className="flex-row gap-4 mt-8">
                    ...
                    >
                        <View className="flex-row items-center">
                            ...
                            <Text className="text-white text-lg font-semibold ml-2">Save Report</Text>
                        </View>
                    </TouchableOpacity>
                </View>
            </ScrollView>
