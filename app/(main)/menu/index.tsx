...
const MenuPage: React.FC = () => {
    const { menuItems, categories: storeCategories, menus: storeMenus, modifierGroups: storeModifierGroups, deleteMenuItem, toggleItemAvailability, getItemsInCategory, getMenuItems, toggleMenuActive, toggleCategoryActive, isMenuAvailableNow, isCategoryAvailableNow } = useMenuStore();
                        ...
                        <View key={menu.id} className="bg-[#303030] rounded-lg border border-gray-700 p-4">
                            <View className="flex-row items-center justify-between mb-4">
                                ...
                                <View className="flex-row items-center gap-2">
                                    ...
                                    <TouchableOpacity
                                        onPress={() => handleToggleMenuActive(menu.id)}
                                        className="p-2 bg-[#212121] rounded border border-gray-600"
                                    >
                                        {menu.isActive ? <Eye size={16} color="#10B981" /> : <EyeOff size={16} color="#EF4444" />}
                                    </TouchableOpacity>

                                    <Link href={`/menu/edit-menu?id=${menu.id}`} asChild>
                            ...
                            <View className="ml-6">
                                ...
                                <View className="gap-2">
                                    {menu.categories.map((category) => (
                                        <View key={category.id} className="flex-row items-center justify-between bg-[#212121] p-3 rounded border border-gray-700">
                                            <View className="flex-row items-center gap-2">
                                            ...
                                            <View className="flex-row items-center gap-1">
                                                <TouchableOpacity
                                                    onPress={() => handleToggleCategoryActive(category.id)}
                                                    className="p-1"
                                                >
                            ...
                            <View key={categoryName} className="bg-[#303030] rounded-lg border border-gray-700 p-4">
                                <View className="flex-row justify-between items-center">
                                    ...
                                    >
                                        ...
                                        <GripVertical size={20} color="#9CA3AF" />
                                        <Text className="font-medium text-white">{categoryName}</Text>
