  ...
  return (
    <KeyboardAvoidingView className="flex-1 bg-[#212121]" behavior="padding">
      ...
      <ScrollView className="flex-1 p-6">
        ...
        {/* Modifier Type */}
        <View className="mb-6">
          <Text className="text-2xl font-semibold text-white mb-4">Type</Text>
          ...
          {formData.options.length === 0 ? (
            <View className="bg-[#303030] border border-gray-600 rounded-lg p-6 items-center">
              <Text className="text-2xl text-gray-400 text-center mb-3">
                No options added yet. Add options to define the choices for this
                modifier.
              </Text>
              <TouchableOpacity
                onPress={addOption}
            ...
            <View className="bg-[#212121] rounded-lg p-6 mb-6">
              <View className="flex-row items-center justify-between mb-2">
                ...
                <View className="flex-row gap-2">
                  <View
                    className={`px-3 py-2 rounded-full ${formData.type === "required" ? "bg-red-900/30 border border-red-500" : "bg-blue-900/30 border border-blue-500"}`}
                  >
                    <Text
                      className={`text-xl ${formData.type === "required" ? "text-red-400" : "text-blue-400"}`}
                    >
                      {formData.type}
                    </Text>
                  </View>
