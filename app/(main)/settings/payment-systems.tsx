          ...
          {expandedSections.kds && (
            <View className="p-5">
              <View className="flex-row items-center justify-between py-3 border-b border-gray-700 mb-4">
                <View className="flex-1 pr-4">
                  <Text className="text-white font-medium">
                    Enable KDS Integration
                  </Text>
                  <Text className="text-gray-400 text-sm">
                    Connect kitchen display screens
                  </Text>
                </View>
                <Switch
                  checked={kdsEnabled}
                  onCheckedChange={(v) =>
                    updateDiningSettings({ kdsEnabled: v })
                  }
                />
              </View>
                ...
                <>
                  {kdsDisplays.map((display) => (
                    ...
                    >
                      <View className="flex-row items-center">
                        <View
                          className={`w-3 h-3 rounded-full mr-3 ${display.status === "online" ? "bg-green-500" : "bg-gray-500"}`}
                        />
                        <View>
                          <Text className="text-white font-medium">
                            {display.name}
                          ...
                          <Text className="text-gray-500 text-xs">
                            {display.ip} • {display.activeOrders} orders
                          </Text>
                        </View>
                      </View>
          ...
          {expandedSections.prep && (
            <View className="p-5">
              <View className="flex-row items-center justify-between py-3 border-b border-gray-700 mb-4">
                ...
                <Switch
                  checked={showPrepTimesToCustomers}
                  onCheckedChange={(v) =>
                    updateDiningSettings({ showPrepTimesToCustomers: v })
                  }
                />
              </View>
              ...
              <View className="flex-row items-center justify-between py-3 mt-2">
                <View className="flex-1 pr-4">
                  <Text className="text-white font-medium">
                    Auto-Adjust for Load
                  </Text>
                  <Text className="text-gray-400 text-sm">
                    Increase times when kitchen is busy
                  </Text>
                </View>
                <Switch
                  checked={autoAdjustPrepTimes}
                  onCheckedChange={(v) =>
                    updateDiningSettings({ autoAdjustPrepTimes: v })
                  }
                />
              </View>
              ...
              {autoAdjustPrepTimes && (
                <View className="bg-yellow-500/10 p-3 rounded-lg border border-yellow-500/30 mt-2">
                  <Text className="text-yellow-400 font-medium">
                    Current Adjustment: +{currentPrepAdjustment} min
                  </Text>
                  <Text className="text-yellow-200/70 text-xs">
                    Kitchen is moderately busy
                  </Text>
                </View>
              )}
            </View>
