    ...
    <View className="flex-1 bg-gray-50 p-6">
      <View className="flex-row gap-6 h-full w-full">
        ...
        <SettingsSidebar
          ...
          currentRoute="/settings/basic/taxes"
        />

        {/* Main Content */}
        <View className="flex-1 bg-white rounded-2xl border border-gray-200 p-6">
          <Text className="text-xl font-bold text-gray-800">Tax Configuration</Text>
          <Text className="text-gray-600 mt-2">Set up tax rates and tax categories for your business.</Text>
        </View>
      </View>
    </View>
  );
