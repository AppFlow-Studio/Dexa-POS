    ...
    <View className="flex-1 bg-[#212121] p-6">
      <View className="flex-row gap-6 h-full w-full">
        ...
        <View className="flex-1 bg-[#303030] rounded-2xl border border-gray-600 p-6">
          <Text className="text-xl font-bold text-white">Tax Configuration</Text>
          <Text className="text-gray-300 mt-2">Set up tax rates and tax categories for your business.</Text>
        </View>
      </View>
    </View>
  );
