...
with_node \
  ...
  --target "/Users/temurbeksayfutdinov/Documents/AppFlowStudios/Dexa-POS/ios/Pods/Target Support Files/Pods-DexaPOS/ExpoModulesProvider.swift" \
  --entitlement "/Users/temurbeksayfutdinov/Documents/AppFlowStudios/Dexa-POS/ios/DexaPOS/DexaPOS.entitlements" \
  --platform "apple" \
  --packages "expo" "expo-asset" "expo-blur" "expo-constants" "expo-dev-launcher" "expo-dev-menu" "expo-file-system" "expo-font" "expo-haptics" "expo-image" "expo-image-picker" "expo-keep-awake" "expo-linear-gradient" "expo-linking" "expo-router" "expo-sharing" "expo-splash-screen" "expo-symbols" "expo-system-ui" "expo-web-browser"
