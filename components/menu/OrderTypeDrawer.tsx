              ...
              >
                {activeOrder?.customer_name ? (
                  <>
                    ...
                    >
                      <User color={colors.teal} size={s(16)} />
                    </View>
                    ...
                    <Edit3 color={colors.teal} size={s(16)} />
                  </>
                ) : (
                  <>
                    <View
          ...
          {currentOrderType === "dine_in" && (
            <View className="gap-y-3">
              ...
              >
                ...
                <ChevronDown color={colors.label} size={s(16)} />
              </TouchableOpacity>
              ...
              {selectedFloor && (
                <View
                  ...
                  style={{ borderColor: colors.border, minHeight: s(300) }}
                >
                  <TableLayoutView
