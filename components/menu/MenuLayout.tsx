                ...
                <View className="w-80 border-r border-gray-700 h-full bg-[#303030]">
                    ...
                    <View className="flex-1">
                        {MENU_SIDEBAR_DATA.map((item) => (
                            <TouchableOpacity
                                key={item.id}
                                className={`p-4 border-b border-gray-700 ${isActive(item.href || "") ? "bg-blue-600/20 border-blue-500" : ""
                                    }`}
                            ...
                            >
                                <View className="flex-row items-center justify-between">
                                    <View className="flex-row items-center gap-3">
                                        ...
                                        <Text
                                            className={`font-medium ${isActive(item.href || "") ? "text-blue-400" : "text-gray-300"
                                                }`}
                                        >
                                            {item.label}
                                        </Text>
