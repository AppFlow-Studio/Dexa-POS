...
const OpenItemAdder = () => {
        ...
        return (
            <View className="gap-3">
                    ...
                    <View key={rowIndex} className="flex-row gap-3">
                        {row.map((button) => (
                            <TouchableOpacity
                                ...
                                className={`flex-1 h-16 rounded-lg items-center justify-center ${button === "backspace"
                                    ? "bg-red-600"
                                    : "bg-[#303030] border border-gray-600"
                                    }`}
                            >
                                <Text className={`text-2xl font-bold ${button === "backspace" ? "text-white" : "text-white"
                                    }`}>
                ...
                <TouchableOpacity
                    ...
                    className="h-12 bg-gray-600 rounded-lg items-center justify-center"
                >
    ...
    return (
        <View className="flex-1 bg-[#212121] p-6">
            <Text className="text-2xl font-bold text-white mb-3">Add Open Item</Text>

            {/* Item Name Input */}
            <View className="mb-6">
                <Text className="text-lg font-semibold text-white mb-3">Item Name</Text>
                <TextInput
            ...
            {/* Price Display */}
            <View className="mb-6">
                <Text className="text-lg font-semibold text-white mb-3">Price</Text>
            ...
            {/* Numpad */}
            <View className="mb-6">
                <Text className="text-lg font-semibold text-white mb-3">Enter Price</Text>
                {renderNumpad()}
            </View>
