...
const MoreOptionsBottomSheet = forwardRef<BottomSheetMethods>((props, ref) => {
    ...
    const handleManagerPinSubmit = () => {
        if (managerPin === "1234") { // Default manager PIN
            setIsTaxExempt(true);
        ...
        <>
            ...
            >
                <BottomSheetView className="flex-1 bg-white rounded-t-3xl overflow-hidden">
                    ...
                    {/* Promo Code Section */}
                    {/* <View className="mb-6">
                            <Text className="text-lg font-semibold text-gray-800 mb-3">Promo Code</Text>
                    ...
                    {/* Order Notes Section */}
                    <View className="p-6">
                        <Text className="text-lg font-semibold text-gray-800 mb-3">Order Notes</Text>
                        <BottomSheetTextInput
                            value={orderNotes}
                            ...
                            multiline
                            numberOfLines={3}
                            className="p-3 bg-gray-100 rounded-xl text-base min-h-[80px]"
                            placeholderTextColor="#6b7280"
                    ...
                    <View className="px-6 pb-6">
                        <Text className="text-lg font-semibold text-gray-800 mb-3">Tax Exempt</Text>
                        <View className="flex-row items-center justify-between">
                            <View>
                                <Text className="text-gray-600">Requires PIN</Text>
                            </View>
                            <TouchableOpacity
                                onPress={handleTaxExemptToggle}
                                className={`w-12 h-6 rounded-full flex-row items-center ${isTaxExempt ? "bg-primary-400" : "bg-gray-300"
                                    }`}
                            >
                                <View
                                    className={`w-5 h-5 bg-white rounded-full shadow-sm ${isTaxExempt ? "ml-6" : "ml-0.5"
                                        }`}
                                />
                            </TouchableOpacity>
                        </View>
                    ...
                    {/* Open Drawer Section */}
                    <View className="px-6 pb-6">
                        <Text className="text-lg font-semibold text-gray-800 mb-3">Open Drawer (No-sale)</Text>
                        <View className="flex-row items-center justify-between">
                            <View className="flex-row items-center">
                                <Text className="text-gray-600 mr-2">Requires PIN</Text>
                            ...
                            >
                                <Text className="font-medium text-gray-800">Open</Text>
                            </TouchableOpacity>
                        </View>
                    </View>
                </BottomSheetView>
                ...
                <View className="flex-1 justify-center items-center bg-black/50">
                    <View className="bg-white rounded-2xl p-6 w-80">
                        ...
                        <TextInput
                            ...
                            maxLength={4}
                            className="p-3 bg-gray-100 rounded-xl text-center text-lg font-bold mb-4"
                            placeholderTextColor="#6b7280"
                        />
                        <View className="flex-row gap-3">
                            ...
                            <TouchableOpacity
                                onPress={isTaxExempt ? handleManagerPinSubmit : handleManagerPinForDrawer}
                                className="flex-1 py-3 bg-primary-400 rounded-xl"
                            >
