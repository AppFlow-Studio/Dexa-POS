      ...
      <GestureDetector gesture={isVoided ? Gesture.Pan() : pan}>
        ...
        >
          <TouchableOpacity
            ...
            disabled={isVoided}
          >
            {/* Item container — kitchen status as left border */}
            <View
              style={
                !isVoided && kitchenBorderColor
                  ? {
                      borderLeftWidth: 3,
              ...
              <View className="flex-row items-center py-0 px-3 gap-2.5">
                ...
                <View
                  style={{
                    ...
                    backgroundColor: isVoided ? colors.border : "transparent",
                  }}
                >
                  <Text
                    style={{
                      fontSize: 14,
                      fontWeight: "700",
                      color: isVoided ? colors.muted : "white",
                    }}
                  >
                    {item.quantity}
                  </Text>
