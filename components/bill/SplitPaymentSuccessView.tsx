...
const SplitPaymentSuccessView = () => {
  ...
  return (
    <View style={{ flex: 1, backgroundColor: colors.screen, alignItems: "center", justifyContent: "center", paddingHorizontal: 16 }}>
      {/* Success Icon */}
      <Animated.View
      ...
      >
        ...
        <Text style={{ fontSize: 28, fontWeight: "800", color: colors.heading, marginBottom: 8, textAlign: "center" }}>
          Payment Received
        </Text>
        <Text style={{ fontSize: 14, color: colors.label, textAlign: "center", lineHeight: 20 }}>
      ...
      {nextSplit && (
        <Animated.View
          ...
          style={{ width: "100%", backgroundColor: colors.panel, borderRadius: 12, borderWidth: 1, borderColor: colors.border, padding: 16, marginBottom: 20 }}
        >
          <Text style={{ fontSize: 11, fontWeight: "700", letterSpacing: 0.5, textTransform: "uppercase", color: colors.muted, marginBottom: 8 }}>
            Next Guest
          </Text>
      ...
      <TouchableOpacity
        ...
        style={{ width: "100%", paddingVertical: 12, backgroundColor: colors.teal, borderRadius: 10, flexDirection: "row", alignItems: "center", justifyContent: "center", gap: 8, shadowColor: colors.teal, shadowOffset: { width: 0, height: 4 }, shadowOpacity: 0.25, shadowRadius: 8, elevation: 6 }}
      >
        <Text style={{ color: colors.onSolid, fontWeight: "700", fontSize: 14 }}>
