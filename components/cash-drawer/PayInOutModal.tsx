...
const PayInOutModal: React.FC<PayInOutModalProps> = ({
  ...
  const handleConfirm = useCallback(async () => {
    ...
    show({
      ...
      message: `${MODE_TITLES[mode]} of ${formatCurrency(parsedAmount)} recorded.`,
      type: "success",
    });
    ...
    resetState();
    onClose();
  }, [drawerId, activeSession, loggedInEmployee, canSubmit, parsedAmount, reason, approvedBy, mode, supabase, show, onClose]);
