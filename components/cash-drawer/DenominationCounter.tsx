  ...
  return (
    <View>
      ...
      <View className="flex-row items-center px-3 py-2 mb-1">
        <Text className="flex-1 text-sm font-semibold text-label">
          Denomination
        </Text>
        <Text className="w-24 text-center text-sm font-semibold text-label">
          Count
        </Text>
        <Text className="w-24 text-right text-sm font-semibold text-label">
          Total
        </Text>
      </View>
      ...
      {denominations.map((d) => (
        ...
        >
          <Text className="flex-1 text-base text-white">{d.label}</Text>
          ...
          <View className="flex-row items-center w-24 justify-center gap-1">
            <TouchableOpacity
              ...
              disabled={d.count <= 0}
            >
              <Minus size={14} color={d.count > 0 ? "white" : colors.muted} />
            </TouchableOpacity>
            ...
            <TextInput
              ...
              className="w-12 h-8 text-center text-base text-white bg-surface border border-border rounded-md"
              selectTextOnFocus
            />
          ...
          <Text className="w-24 text-right text-base text-white">
      ...
      {/* Grand Total */}
      <View className="flex-row items-center px-3 py-3 mt-1 bg-surface rounded-lg">
        <Text className="flex-1 text-lg font-bold text-white">Total</Text>
