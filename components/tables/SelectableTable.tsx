        ...
        <GestureDetector gesture={tapGesture}>
            ...
            >
                <TouchableOpacity
                    ...
                    className={`${getTableSize()} ${getTableShape()} items-center justify-center border-2 ${isSelected
                ...
                >
                    ...
                    <View
                        ...
                        style={{
                            backgroundColor: isSelected ? "#3B82F6" : STATUS_COLORS[table.status],
                        }}
                    />
                    ...
                    {/* Capacity */}
                    <Text
                        className={`text-xs text-center ${isSelected ? "text-blue-200" : "text-gray-500"
                            }`}
                    >
                    ...
                    {/* Selection Indicator */}
                    {isSelected && (
                        <View className="absolute inset-0 border-2 border-blue-400 rounded-lg bg-blue-600/20" />
                    )}
                </TouchableOpacity>
            </Animated.View>
        </GestureDetector>
