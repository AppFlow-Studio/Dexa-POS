...
const DetailRow = ({
  ...
  <View className="flex-row justify-between items-center py-2 border-b border-dashed border-gray-200">
    <Text className="text-base text-accent-500">{label}</Text>
    <Text className="text-base font-semibold text-accent-500">{value}</Text>
  </View>
);
    ...
    <Dialog open={isOpen} onOpenChange={onClose}>
      <DialogContent className="p-0 rounded-[36px] overflow-hidden bg-[#11111A] w-[550px]">
        ...
        <View className="p-6 rounded-[36px] bg-background-100 gap-y-4">
          ...
          {/* Footer with Buttons */}
          <DialogFooter className="p-6 flex-row gap-3 border-t border-gray-200">
            <TouchableOpacity className="flex-1 flex-row justify-center items-center gap-2 py-3 border border-gray-300 rounded-lg">
              ...
              <Text className="font-bold text-gray-700">Send Email</Text>
            </TouchableOpacity>
