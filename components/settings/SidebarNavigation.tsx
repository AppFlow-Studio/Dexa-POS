...
const SETTINGS_SECTIONS: SidebarSection[] = [
  {
    ...
    items: [
      { id: "devices-connections", label: "Devices & Connections", icon: Smartphone, route: "/settings/devices-connections" },
      { id: "printers-kitchen", label: "Print & KDS Config", icon: Printer, route: "/settings/printers-kitchen" },
      { id: "receipt-templates", label: "Receipt Templates", icon: Receipt, route: "/settings/receipt-templates" },
      { id: "payment-systems", label: "Payment & Pricing", icon: Banknote, route: "/settings/payment-systems" },
      ...
      { id: "stations-devices", label: "Customer Display", icon: Monitor, route: "/settings/stations-devices" },
