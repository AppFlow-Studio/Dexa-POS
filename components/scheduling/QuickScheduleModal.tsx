...
const QuickScheduleModal: React.FC<QuickScheduleModalProps> = ({ isOpen, onClose, onCreate }) => {
        ...
        <Dialog open={isOpen} onOpenChange={onClose}>
            <DialogContent className="w-[550px] max-w-lg bg-[#303030] rounded-2xl border-gray-700 p-0">
                <DialogHeader className="p-6 border-b border-gray-700">
                    <DialogTitle className="text-white text-xl font-bold">Create Schedule for Week</DialogTitle>
                </DialogHeader>
                <View className="p-6">
                    <Calendar
                        current={startDate}
