  ...
  return (
    <View style={{ gap: 10 }}>
      ...
      {balanceDue > 0 && (
        ...
        >
          <Text style={{ fontSize: 11, color: colors.teal, marginBottom: 2, fontWeight: "600", textTransform: "uppercase", letterSpacing: 0.5 }}>
            Balance Due
          </Text>
...
const SummaryCard = ({
  ...
  >
    <View style={{ width: 26, height: 3, borderRadius: 2, backgroundColor: accentColor, marginBottom: 8 }} />
    <Text style={{ fontSize: 11, color: colors.label, marginBottom: 3, textTransform: "uppercase", letterSpacing: 0.5, fontWeight: "600" }}>
      {label}
    </Text>
