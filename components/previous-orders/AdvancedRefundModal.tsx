...
const AdvancedRefundModal: React.FC<AdvancedRefundModalProps> = ({ isOpen, onClose, order }) => {
                ...
                <DialogHeader>
                    ...
                    <View className="flex-row items-center justify-between mt-2">
                        ...
                        <View className={`px-3 py-1 rounded-full ${getStatusColor(order.paymentStatus)}`}>
                            <Text className={`font-semibold text-xs ${getStatusColor(order.paymentStatus)}`}>
                                {order.paymentStatus}
                            </Text>
                        </View>
                    </View>
