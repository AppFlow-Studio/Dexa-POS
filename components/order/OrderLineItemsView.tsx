...
const OrderLineItemsView = ({
  ...
  return (
    <View className="bg-[#212121] p-4 rounded-2xl border border-gray-700">
      <View className="items-center mb-6">
        <Text className="text-2xl font-bold text-white">Items in Order</Text>
      ...
      <View className="border-t border-gray-700 pt-3 mt-4 space-y-2">
        ...
        <TouchableOpacity
          onPress={onClose}
          className="w-full py-3 mt-4 bg-[#303030] border border-gray-600 rounded-xl items-center"
        >
          <Text className="text-lg font-bold text-white">Return</Text>
        </TouchableOpacity>
      </View>
    </View>
  );
