        ...
        {(cashPaymentTips > 0 || summaryLoading) && (
          <View style={styles.statRow}>
            ...
            {summaryLoading ? (
              ...
              <Text style={styles.statValue}>{formatCurrency(cashPaymentTips)}</Text>
            )}
          </View>
        )}
      ...
      <View style={{ flexDirection: 'row', gap: 10 }}>
        ...
        <TouchableOpacity
          ...
          style={{
            ...
            paddingVertical: 13,
            borderRadius: 10,
            backgroundColor: declaredAmount > 0 ? colors.teal : colors.teal + '40',
            alignItems: 'center',
          }}
        >
    ...
    <View style={{ gap: 20 }}>
      ...
      >
        <View style={{ flexDirection: 'row', justifyContent: 'space-between' }}>
          <Text style={{ fontSize: 13, color: colors.label }}>Additional Cash Declared</Text>
        ...
        {cashPaymentTips > 0 && (
          <>
            <View style={{ height: 1, backgroundColor: colors.border }} />
            <View style={{ flexDirection: 'row', justifyContent: 'space-between' }}>
              <Text style={{ fontSize: 13, color: colors.label }}>Cash Payment Tips (tracked)</Text>
              <Text style={{ fontSize: 13, color: colors.heading }}>
      ...
      >
        ...
        <Text style={{ flex: 1, fontSize: 10, color: colors.warning }}>
          Your final tips may be adjusted after the manager approves today's distribution.
        </Text>
      </View>
    ...
    <Modal visible={isOpen} transparent animationType='fade' onRequestClose={onCancel}>
      ...
      >
        ...
        >
          ...
          >
            <Text style={{ fontSize: 15, fontWeight: '700', color: colors.heading }}>
              {step === 'summary' ? 'Shift Summary' : step === 'input' ? 'Cash Tips' : 'Confirm & Clock Out'}
            </Text>
            <TouchableOpacity
              onPress={onCancel}
              hitSlop={8}
